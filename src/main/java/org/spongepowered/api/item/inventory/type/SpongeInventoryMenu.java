...
public class SpongeInventoryMenu implements InventoryMenu {
    ...
    @Override
    public MenuCallback registerClick(SlotClickHandler callback, SlotIndex... slotIndices) {
        SpongeMenuCallback cb = new SpongeMenuCallback(); // TODO handler
        return registerCallback(cb, slotIndices);
    }

    @Override
    public MenuCallback registerChange(SlotChangeHandler callback, SlotIndex... slotIndices) {
        SpongeMenuCallback cb = new SpongeMenuCallback(); // TODO handler
        return registerCallback(cb, slotIndices);
    }
